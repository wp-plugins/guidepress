...
class VideoPress {
  ...
  public function media_button() {
    echo '<a href="https://public-api.wordpress.com/videopress-plugin.php?page=video-plugin&amp;video_plugin=1&amp;iframe&amp;TB_iframe=true" id="add_video" class="thickbox" title="VideoPress"><img src="' . esc_url( plugins_url( ) . '/' . dirname( plugin_basename( __FILE__ ) ) . '/images/camera-video.png' ) . '" alt="VideoPress" width="16" height="16" /></a>';
  }
}
...
class VideoPress_Video {
   ...
   */
  public function __construct( $guid, $maxwidth=525 ) {
   ...
   * @todo remove when targeting PHP 5 (WordPress 3.2 requirement) or above.
   */
  public function VideoPress_Video( $guid, $maxwidth=525 ) {
    $this->__construct( $guid, 525 );
  }
